...
const renderSuggestion = (suggestion) => <div style={{ color: "white" }}>{suggestion}</div>;
    ...
    return (
      <div className="App">
        ...
        <div className="bloglink">
          ...
          See{" "}
          <a style={{ color: "#ddd" }} href="http://docs.upstash.com/tutorials/auto_complete_with_serverless_redis">
            the blog post.
          </a>
        </div>
      </div>
