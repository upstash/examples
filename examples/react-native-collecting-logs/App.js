...
class Appp extends React.Component {
  ...
  async costQuery(code) {
    ...
    await fetch(`https://us1-maximum-boar-36431.upstash.io/get/${code}`, {
      headers: {
        Authorization:
          "Bearer Ao5PACQgMTg1YmQxNzItMzM3My00OTE0LWE3ZDQtMWQ1NmY2NjY5OTBk93BHVkmHB8LViUm4YLBFHQG2sHKJ3OX6xqfz2zyYEqQ=",
      },
    })
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            <Image style={{ width: "100%", height: "100%" }} source={require("./images/1.png")} />
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              padding: 10,
          ...
          >
            <Image style={{ width: "100%", height: "100%" }} source={require("./images/2.png")} />
          </TouchableOpacity>
        </View>
        ...
        >
          ...
          >
            <Image style={{ width: "100%", height: "100%" }} source={require("./images/3.png")} />
          </TouchableOpacity>
          <TouchableOpacity
            style={{
              padding: 10,
          ...
          >
            <Image style={{ width: "100%", height: "100%" }} source={require("./images/4.png")} />
          </TouchableOpacity>
        </View>
