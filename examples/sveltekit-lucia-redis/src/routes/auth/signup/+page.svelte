<script lang="ts">
	...
	let passwordConfirmation = data.defaultAuthFormValues.passwordConfirmation;
</script>
	...
	<Left>
		...
		<div class="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
			<div class="flex flex-col space-y-2 text-center">
				<h1 class="text-2xl text-white font-semibold tracking-tight">Sign up for an account</h1>

				<p class="text-sm text-gray-500">
					Already have an account?

					<a href={SIGNIN_PATH} class="underline underline-offset-4 hover:text-primary">
						Sign in
					</a>
				</p>
			</div>
