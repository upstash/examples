...
class Appp extends React.Component {
  ...
  async componentDidMount() {
    let version = await EncryptedStorage.getItem("announcement_version");
    if (version == null) {
      version = "-1";
    }
    ...
    console.log(version);
    await fetch(
      `https://us1-sharing-dassie-35422.upstash.io/zrangebyscore/Announcements/+inf/${version}/WITHSCORES/LIMIT/0/1`,
      {
        method: "GET",
        headers: {
          Authorization:
            "Bearer AopeACQgZGQwNDA5ODktMmEzYy00NmM5LTg4MTQtM2U4NTQ5OTMxZTEySVgyTr4DQTX0HnyHo-YWG1xRXdr64-EngpCYIHhanJY=",
